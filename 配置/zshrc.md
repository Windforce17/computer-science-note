...
# pwn
alias use-223='_patchelf(){ patchelf --replace-needed libc.so.6 ./libc/lib/x86_64-linux-gnu/libc-2.23.so $1 && patchelf --set-interpreter ./libc/lib/x86_64-linux-gnu/ld-2.23.so $1; }; _patchelf'
